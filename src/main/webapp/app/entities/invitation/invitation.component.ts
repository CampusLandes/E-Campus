...
export class InvitationComponent implements OnInit, OnDestroy {
  ...
  loadPage(page?: number): void {
    ...
    this.invitationService
      ...
      .subscribe(
        (res: HttpResponse<IInvitation[]>) => this.onSuccess(res.body, res.headers, pageToLoad),
        () => this.onError()
      );
  }
  ...
  protected onSuccess(data: IInvitation[] | null, headers: HttpHeaders, page: number): void {
