...
import { AddRequestComponent } from 'app/entities/add-request/add-request.component';
...
describe('Component Tests', () => {
  describe('AddRequest Management Component', () => {
    let comp: AddRequestComponent;
    ...
    beforeEach(() => {
      TestBed.configureTestingModule({
        ...
        .overrideTemplate(AddRequestComponent, '')
        .compileComponents();
    ...
    it('Should call load all on init', () => {
      ...
      expect(comp.addRequests && comp.addRequests[0]).toEqual(jasmine.objectContaining({ id: 123 }));
    });
